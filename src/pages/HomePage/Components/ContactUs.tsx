      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-700 mt-4 max-w-xl mx-auto">
            Questions, feedback, or custom requests? We’re here to help and
            ...
            <CardContent className="text-gray-700 space-y-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Wondering where your order is or need help with a recent
                    purchase? We’re happy to assist with updates, tracking, or
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Looking for personalized stationery that reflects your style
                    or brand? Share your ideas — we’ll bring them to life with
                    care and creativity.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Your thoughts make us better. Whether it’s praise,
                    constructive feedback, or improvement ideas — we’re all
                    ears!
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold">
                    General Inquiries or Just Saying Hi
                  </p>
                  <p className="text-sm text-gray-600">
                    Curious about our brand, our story, or have something else
                    on your mind? Even if it’s just a friendly hello — we’d love
                    to hear from you.
                  </p>
                </div>
              </div>
