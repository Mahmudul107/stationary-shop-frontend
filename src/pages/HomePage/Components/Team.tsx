      ...
      <section className="bg-[#f9f7f3] dark:bg-gray-900">
        <div className="container px-6 py-10 mx-auto">
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
            <div className="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-green-700 bg-white dark:border-gray-700 dark:hover:border-transparent">
              <img
